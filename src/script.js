...
(function setupChatbotUI() {
  ...
  if (!document.getElementById(styleId)) {
    ...
    st.textContent = `
      ...
      .cb-input button { padding: 10px 14px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.16); color: #fff; background: linear-gradient(135deg, #7c3aed, #5b21b6); cursor: pointer; }
      /* Typing indicator */
  ...
  function ensurePanel() {
    ...
    panel.innerHTML = `
      <div class="cb-header">
        <div class="cb-title"><span>🤖</span><span>Chatbot</span></div>
        <button class="cb-close">Close</button>
      </div>
      <div class="cb-body">
        <div class="cb-messages" id="cb-messages"></div>
        <form class="cb-input" id="cb-form">
          <input id="cb-input" type="text" placeholder="Ask something..." autocomplete="off" />
